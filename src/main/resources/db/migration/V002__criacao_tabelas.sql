...
create table restaurante (id bigint not null auto_increment, data_atualizacao datetime, data_cadastro datetime not null, endereco_bairro varchar(20) not null, endereco_cep varchar(9) not null, endereco_complemento varchar(20), endereco_logradouro varchar(20) not null, endereco_numero varchar(10) not null, nome varchar(100) not null, taxa_frete decimal(19,2) not null, cozinha_id bigint not null, endereco_cidade_id bigint not null, primary key (id)) engine=InnoDB;
